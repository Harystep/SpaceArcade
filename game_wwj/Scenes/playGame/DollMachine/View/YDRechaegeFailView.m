...
@implementation YDRechaegeFailView
...
- (void)createSubviews {
    ...
    self.statusIv = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ico_faile_x"]];
    ...
    [titleL mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.statusIv.mas_bottom).offset(25);
